...
class MapSampleState extends State<MapSample> {
  ...
  void addReserve5() {
    ...
    polygonLatLngs.add(point2);
    polygonLatLngs.add(point3);
    var rpa = RPA('Årstaskogen - Årsta holmar Naturreservat','Protected since: 2018', 'Size: 66 hectare', null, null, polygonLatLngs);
    rpas.add(rpa);
    _setPolygon(rpa);
  }
  ...
  void addReserve13() {
    ...
    polygonLatLngs.add(point2);
    polygonLatLngs.add(point3);
    var rpa = RPA('Sätraskogen Naturreservat','Protected since: 2006', 'Size: 256 hectare', 59.281630, 17.910636, polygonLatLngs);
    rpas.add(rpa);
    _setPolygon(rpa);
  }
  ...
  void addReserve17() {
    ...
    var rpa = RPA('Tyresta Naturreservat', 'Protected since: 1936', 'Size: 4900 hectare', 59.15402772456425, 18.301106178869812, polygonLatLngs);
    rpas.add(rpa);
    _setPolygon(rpa);
  }
