...
import 'package:kayak_sthlm/dialogs/settingsInfo_dialog.dart';
...
class InfoInfoDialog extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => InfoInfoOverlayState();
}

class InfoInfoOverlayState extends State<InfoInfoDialog> {
  @override
  void initState() {
    super.initState();
  }
          ...
          Align(
            child: Row(mainAxisAlignment: MainAxisAlignment.end, children: <
              ...
              OutlinedButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).pushReplacement(PageRouteBuilder(
                        pageBuilder: (context, _, __) => EventsInfoDialog(),
                        opaque: false,
              ...
              OutlinedButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).pushReplacement(PageRouteBuilder(
                        pageBuilder: (context, _, __) => SettingsInfoDialog(),
                        opaque: false,
                        barrierColor: Colors.black.withOpacity(0.2)));
                  }),
              SizedBox(width: 11)
                  ...
                  child: Container(
                    ...
                    child: RichText(
                        text: TextSpan(
                          ...
                          TextSpan(text: 'Here you can see current '),
                          TextSpan(
                              text: 'fire bans, wildlife preserves ',
