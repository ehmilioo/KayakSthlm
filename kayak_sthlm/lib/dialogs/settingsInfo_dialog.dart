...
class SettingsInfoDialog extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => SettingsInfoOverlayState();
}

class SettingsInfoOverlayState extends State<SettingsInfoDialog> {
  @override
  void initState() {
    super.initState();
  }
                  ...
                  child: Container(
                    ...
                    child: RichText(
                        text: TextSpan(
                          ...
                          TextSpan(text: 'Here you can see your '),
                          TextSpan(
                              text: 'account, ',
                          ...
                          TextSpan(
                              text: 'changes ',
                              style: TextStyle(fontStyle: FontStyle.italic)),
                          TextSpan(text: 'to it as well as '),
                          TextSpan(
                              text: 'delete ',
                              style: TextStyle(fontStyle: FontStyle.italic)),
                          TextSpan(text: 'it or '),
